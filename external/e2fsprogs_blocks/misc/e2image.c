...
extern blk_list meta_data_block_list;
...
skip_device:
	...
	block_list_file=fopen(argv[optind+2], "w");
	if (NULL == block_list_file){
		exit(1);
	}

	written_objects = fwrite(&meta_data_block_list, sizeof(blk_list),1, block_list_file);
