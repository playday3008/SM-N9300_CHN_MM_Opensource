...
blk_list meta_data_block_list = {0};
			      ...
			      int count, void *bufv)
{
	...
	meta_data_block_list.blk_list[meta_data_block_list.num_entries].location = location;
	meta_data_block_list.blk_list[meta_data_block_list.num_entries].len = size;
	meta_data_block_list.num_entries++;
