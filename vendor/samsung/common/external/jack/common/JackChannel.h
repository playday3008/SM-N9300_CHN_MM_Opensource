...
class JackClientChannelInterface
{
    ...
    public:
		...
		virtual void ClientStopJackd(int refnum, int param, int* result)
        {}
		virtual void ClientSwitchMaster(int refnum, int type, int param, int* result)
        {}
		#endif
		#if defined (__ANDROID__) && defined (ENABLE_JACK_LOGGER)
		virtual void ClientStartDump(int refnum, int type, int param, int* result)
        {}
		virtual void ClientStopDump(int refnum, int param, int* result)
        {}
		virtual void ClientDump(int refnum, int param, int* result)
        {}
		#endif
};
