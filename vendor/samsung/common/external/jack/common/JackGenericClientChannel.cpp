...
void JackGenericClientChannel::ClientStopJackd(int refnum, int param, int* result)
{
    JackStopJackdRequest req(refnum, param);
    JackResult res;
    ServerSyncCall(&req, &res, result);
}

void JackGenericClientChannel::ClientSwitchMaster(int refnum, int type, int param, int* result)
{
	JackSwitchMasterRequest req(refnum, type, param);
	JackResult res;
	ServerSyncCall(&req, &res, result);
}
#endif
...
void JackGenericClientChannel::ClientStartDump(int refnum, int type, int param, int* result)
{
	JackStartDumpRequest req(refnum, type, param);
	JackResult res;
	ServerSyncCall(&req, &res, result);
}

void JackGenericClientChannel::ClientStopDump(int refnum, int param, int* result)
{
    JackStopDumpRequest req(refnum, param);
    JackResult res;
    ServerSyncCall(&req, &res, result);
}

void JackGenericClientChannel::ClientDump(int refnum, int param, int* result)
{
    JackDumpRequest req(refnum, param);
    JackResult res;
    ServerSyncCall(&req, &res, result);
}
#endif
