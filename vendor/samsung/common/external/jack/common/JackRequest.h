...
/*!
\brief StopJackd request.
*/

struct JackStopJackdRequest : public JackRequest
{

    int fRefNum;
    int fParam;

    JackStopJackdRequest()
    {}
    JackStopJackdRequest(int refnum, int param)
        : JackRequest(JackRequest::kStopJackd), fRefNum(refnum), fParam(param)
    {}
    ...
    int Read(detail::JackChannelTransactionInterface* trans)
    {
        CheckSize();
        CheckRes(trans->Read(&fRefNum, sizeof(int)));
        return trans->Read(&fParam, sizeof(int));
    }
    ...
    int Write(detail::JackChannelTransactionInterface* trans)
    {
        CheckRes(JackRequest::Write(trans, Size()));
        CheckRes(trans->Write(&fRefNum, sizeof(int)));
        return trans->Write(&fParam, sizeof(int));
    }
...
/*!
\brief SwitchMaster request.
*/

struct JackSwitchMasterRequest : public JackRequest
{
    ...
    JackSwitchMasterRequest()
    {}
    JackSwitchMasterRequest(int refnum, int type, int param)
        : JackRequest(JackRequest::kSwitchMaster), fRefNum(refnum), fType(type), fParam(param)
    {}
    ...
    int Read(detail::JackChannelTransactionInterface* trans)
    {
        CheckSize();
        CheckRes(trans->Read(&fRefNum, sizeof(int)));
		CheckRes(trans->Read(&fType, sizeof(int)));
        return trans->Read(&fParam, sizeof(int));
    }
    ...
    int Write(detail::JackChannelTransactionInterface* trans)
    {
        CheckRes(JackRequest::Write(trans, Size()));
        CheckRes(trans->Write(&fRefNum, sizeof(int)));
		CheckRes(trans->Write(&fType, sizeof(int)));
        return trans->Write(&fParam, sizeof(int));
    }
...
/*!
\brief StartDump request.
*/

struct JackStartDumpRequest : public JackRequest
{
    ...
    JackStartDumpRequest()
    {}
    JackStartDumpRequest(int refnum, int type, int param)
        : JackRequest(JackRequest::kStartDump), fRefNum(refnum), fType(type), fParam(param)
    {}
...
/*!
\brief StopDump request.
*/

struct JackStopDumpRequest : public JackRequest
{
    ...
    JackStopDumpRequest()
    {}
    JackStopDumpRequest(int refnum, int param)
        : JackRequest(JackRequest::kStopDump), fRefNum(refnum), fParam(param)
    {}
...
struct JackDumpRequest : public JackRequest
{
    ...
    JackDumpRequest()
    {}
    JackDumpRequest(int refnum, int param)
        : JackRequest(JackRequest::kStopJackd), fRefNum(refnum), fParam(param)
    {}
